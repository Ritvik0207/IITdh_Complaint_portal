...
const updateStatus = async (req, res) => {
    try {
        ...
        // Assuming you have a ComplaintModel defined elsewhere in your code
        // and it represents your complaint schema/model
        if (!isApproved) {
            ...
            return res.status(200).json({ success: true, message: 'Complaint rejected and deleted successfully', complaint: deletedComplaint });
        }
        ...
        return res.status(200).json({ success: true, message: 'Complaint status updated successfully', complaint: updatedComplaint });
    } catch (error) {
